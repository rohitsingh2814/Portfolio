...
const projects = [
    ...
    , {
        title: "KrushAI",
        description: "An AI-based web app that suggests outfits based on user input and occasion with product links.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            ...
            >
              {/* Image */}
              <div className="relative overflow-hidden aspect-video "  onClick={() => setShow(!show)}>
        ...
        <div className="text-center mt-12 animate-fade-in animation-delay-500">
          <a href="https://github.com/rohitsingh2814" target="_blank">
